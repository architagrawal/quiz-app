        ...
        <main>
            ...
            {isQuiz && 
                <div className="quiz-page">
                    ...
                    { complete && (
                        <p className="answer-count-container">You scored {answerCount} / 5 correct answers 
                        <button className="check-answers-btn play-again-btn" onClick={restartQuiz}>Play Again </button>
                        </p> 
                    )
                    }
                </div>
